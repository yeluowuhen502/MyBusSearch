...
import com.marsjiang.wuhubussearch.beans.getbeans.BusComingBean;
import com.marsjiang.wuhubussearch.beans.getbeans.GetArrivalInfo;
import com.marsjiang.wuhubussearch.beans.getbeans.GetSearchStationBean;
import com.marsjiang.wuhubussearch.beans.sendbusbean.SendBusIdBean;
import com.marsjiang.wuhubussearch.beans.sendbusbean.SendBusNumBean;
...
public class BusStation_around_show extends Activity {
		...
		httpUtils.send(HttpMethod.POST,"http://220.180.139.42:8980/SmartBusServer/Main", params,new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> string) {
				...
				try {
					...
					JSONArray upLineStationList_00 = result
							.getJSONArray("upLineStationList");
					JSONArray downLineStationList_00 = result
							.getJSONArray("downLineStationList");

					List<com.marsjiang.wuhubussearch.beans.getbeans.UpLineStationList> uplinestationlist = new ArrayList<com.marsjiang.wuhubussearch.beans.getbeans.UpLineStationList>();
					List<com.marsjiang.wuhubussearch.beans.getbeans.DownLineStationList> downlinestationlist = new ArrayList<com.marsjiang.wuhubussearch.beans.getbeans.DownLineStationList>();
					for (int i = 0; i < upLineStationList_00.length(); i++) {
						com.marsjiang.wuhubussearch.beans.getbeans.UpLineStationList temp00 = new com.marsjiang.wuhubussearch.beans.getbeans.UpLineStationList();
					...
					for (int i = 0; i < downLineStationList_00.length(); i++) {
						com.marsjiang.wuhubussearch.beans.getbeans.DownLineStationList temp01 = new com.marsjiang.wuhubussearch.beans.getbeans.DownLineStationList();
